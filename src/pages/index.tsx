    ...
    <AnimateFade>
      ...
      <main>
        <section>
          ...
          <br></br>
          <div className="banner1200">Ad 120 * 600</div>
          <div className="banner120">Ad 120 * 600</div>
          <div>
            <div className='layout flex flex-col items-center gap-0 pt-0 text-center'>
              ...
              <br></br>
              <div className='banner68'>Full banner (468 * 60 pixel) </div>
